...
.r-leaderboard-wing {
  ...
  .r-leaderboard-encounter {
    ...
    .r-leaderboard-row {
      grid-column: 1 / -1;
      grid-template-columns: $global-spacing*6 $global-spacing*14 1fr;
      display: none;
      grid-gap: $global-small-gutter;
      ...
      .r-rank {
        border-radius: $global-border-radius;
        color: darken($global-muted-background, 8%);
        font-weight: 600;
        opacity: 0.8;
      }
      &:nth-of-type(2) .r-rank {
          background-color: percentile-color('99', 'default');
        }
      &:nth-of-type(3) .r-rank {
          background-color: percentile-color('90', 'default');
        }
      &:nth-of-type(4) .r-rank {
          background-color: percentile-color('80', 'default');
        }
      &:nth-of-type(5) .r-rank {
          background-color: percentile-color('70', 'default');
        }
      &:nth-of-type(6) .r-rank {
          background-color: percentile-color('60', 'default');
        }
      &:nth-of-type(7) .r-rank {
          background-color: percentile-color('50', 'default');
        }
      &:nth-of-type(8) .r-rank {
          background-color: percentile-color('40', 'default');
        }
      &:nth-of-type(9) .r-rank, &:nth-of-type(10) .r-rank, &:nth-of-type(11) .r-rank {
          background-color: percentile-color('30', 'default');
        }
      &:nth-of-type(11) {
        .dps, .duration {
      ...
      @media (max-width: $breakpoint-small) {
        grid-template-columns: $global-spacing*6 1fr;
        .r-damage {
          display: none;
        }
      }
      ...
      .r-remaining, .r-damage {
        color:mix($global-color, $global-background, 70%);
        font-size: $global-small-font-size;
        letter-spacing: 0;
      }
      .r-time h3 {
    ...
    .r-damage, .r-buffs, .r-composition {
      height: 44px;
    }
    ...
    &.expanded {
      ...
      .r-leaderboard-row {
        grid-column: 1 / -1;
        grid-template-columns: $global-spacing*6 minmax($global-spacing*24, 1fr);
        display: grid;
        position: relative;
        overflow: hidden;
        cursor: pointer;
        .r-damage, .r-composition, .r-buffs {
          display: none;
        }
        &:before {
          opacity: 0;
        ...
        @media (min-width: $breakpoint-small) {
          grid-template-columns: $global-spacing*6 minmax($global-spacing*24, 1fr) minmax($global-spacing*34, 1fr);
          .r-damage {
            display: grid;
            grid-gap: $global-small-gutter/2;
          }
        ...
        @media (min-width: $breakpoint-medium) {
          grid-template-columns: $global-spacing*6 minmax($global-spacing*24, 1fr) minmax($global-spacing*34, 1fr) max-content max-content;
          .r-damage {
            grid-column: span 1;
          }
          .r-buffs, .r-composition, .r-damage {
            display: grid;
            grid-gap: $global-small-gutter/2;
          }
        }
