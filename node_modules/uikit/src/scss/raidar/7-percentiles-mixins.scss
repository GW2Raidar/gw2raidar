...
.percentile-rainbow {
  ...
  %exotic {
    background-color: percentile-color('80', 'rainbow') !important;
    fill: percentile-color('80', 'rainbow');
    border: $global-border-width solid darken(percentile-color('80', 'rainbow'), 20%);
  }
