...
.r-encounter-stats-container {
  ...
  @media (min-width: $breakpoint-large) {
    .r-stats-row {
      display: grid;
      grid-template-columns: 160px minmax(300px, 3fr) 1fr minmax(300px, 4fr) 60px;
      grid-gap: $global-small-gutter;
    }
  }
  .r-encounter-player {
  ...
  .r-encounter-buff-container {
    ...
    li.uk-active {
      display: grid;
      grid-template-columns: repeat(auto-fit, minmax(max-content, 84px));
...
.r-encounters-list {
  ...
  grid-template-rows: 60px repeat(6, fit-content(100px)) 1fr;
  grid-gap: $global-small-gutter;
