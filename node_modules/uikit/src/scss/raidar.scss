...
$global-link-color:                              #832759;
$global-link-hover-color:                        #915B79;
...
.r-encounter-stats-container {
  ...
  @media (min-width: $breakpoint-large) {
    .r-stats-row {
      display: grid;
      grid-template-columns: 160px 2fr repeat(3, 1fr) 2fr;
      grid-gap: $global-small-gutter;
    }
  }
  .r-encounter-player {
...
.r-bg-80 {
  ...
  text-shadow: 0 0 1px darken($exotic-color, 50%);
}
.r-bg-70 {
  background-color: $rare-color !important;
  text-shadow: 0 0 2px darken($rare-color, 70%);
}
.r-bg-60 {
