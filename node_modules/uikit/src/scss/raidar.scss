...
$legendary-color:                                   #903CC9;
$ascended-color:                                    #5F42DE;
$exotic-color:                                      #3C6FCE;
$rare-color:                                        #4883A8;
$uncommon-color:                                    #be7c15;
$common-color:                                      #CF9329;
$trash-color:                                       #6A656B;
...
.r-main-nav {
  background: rgba($global-background, .35);
}
...
@for $i from 0 through 29 {
  .r-bg-#{$i} {
    ...
    fill: $trash-color;
    border: 1px solid darken($trash-color, 20%);
  }
}
@for $i from 0 to 41 {
	.r-bg-#{$i + 29} {
		background-color: mix($exotic-color, $trash-color, percentage($i / ($less50 - 1))) !important;
    fill: mix($exotic-color, $trash-color, percentage($i / ($less50 - 1)));
    border: 1px solid darken(mix($exotic-color, $trash-color, percentage($i / ($less50 - 1))), 20%);
	}
}
@for $i from 0 to 42 {
	.r-bg-#{$i + 59} {
		background-color: mix($legendary-color, $exotic-color, percentage($i / ($upto100 - 1))) !important;
    fill: mix($legendary-color, $exotic-color, percentage($i / ($upto100 - 1)));
    border: 1px solid darken(mix($legendary-color, $exotic-color, percentage($i / ($upto100 - 1))), 20%);
	}
}
...
//     fill: $common-color;
//     border: 1px solid darken($common-color, 20%);
//     text-shadow: 0 0 2px darken($common-color, 30%);
//   }
// }
...
//     fill: $uncommon-color;
//     border: 1px solid darken($uncommon-color, 20%);
...
//     border: 1px solid darken($rare-color, 20%);
//   }
// }
...
//     fill: $exotic-color;
//     border: 1px solid darken($exotic-color, 20%);
//   }
// }
...
//     fill: $ascended-color;
//     border: 1px solid darken($ascended-color, 20%);
//
//   }
// }
...
//     border: 1px solid darken($legendary-color, 20%);
//
//   }
// }
